...
### 完了条件
- Epicカードの内容を確認し、懸念点があればコメント/修正提案を残す。
- 問題なければ承認コメントを記載し、Objective作成へ進める判断を出す。
...
- 問題なければ承認コメントを記載し、Spec作成へ進める判断を出す。
...
### 指示
上記のSpecカードの内容をレビューしてください。
**ファイルではなく、カードの説明欄に記載された設計内容を確認してください。**
これは設計段階のレビューです。実装コードは存在しません。
